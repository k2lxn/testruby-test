...
describe "#multiply" do
  ...
  it "multiplies two numbers" do
  	multiply(2.0,5).should == 10.0
  end

  it "multiplies several numbers" do
  	multiply(4,7.5,4.2).should == 126.0
  end
...
#  it "gives a useful error message for negative numbers" do
#  	factorial(-3).should == "Please enter a positive integer"
#  end
#  it "gives a useful error message for non-integers" do
#  	factorial(5.3).should == "Requires an integer"
#  end
end
